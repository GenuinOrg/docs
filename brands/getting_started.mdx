...
2. Visit [Genuin website](https://begenuin.com/) and click on ‘Get Started’ CTA. 
...
- You can edit the fetched information on this stage as well as modify it later under the Settings module.
