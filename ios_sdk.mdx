...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        var configuration = BGHome.Configuration()
        configuration.showSidePanel = false

        BGHome.shared.initialize(appKey: "YOUR_GENUIN_APP_KEY", appSecret: "YOUR_GENUIN_APP_SECRET", configuration: configuration)

        if let homeFeedController = BGHome.shared.getHomeScreen() {
