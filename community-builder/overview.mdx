...
If you want to create your own interest-based community, scan and download the Genuin app.
<img height="200" src="/visual-aids/Scan to download the app.png />

or

Click on ‘Become a Community Builder on Genuin’ option available on a menu bar of Genuin’s Webapp → Click on ‘Download Genuin App’ → Set up your profile and start creating your interest-based community. 
