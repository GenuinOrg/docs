...
| Tracking (NSUserTrackingUsageDescription) | This is the message which informs users that why the app is asking for permission. | Monetization |
...
target 'YourProject' do
  ...
  pod "GenuinSDK", :git => "https://bitbucket.org/genuindev/genuin_sdk_ios.git", :tag => "1.1.15.1"
...
To enable Monetization use following code snippet to get **advertisingIdentifier** by **AppTrackingTranspancy**
...
<img height="200" src="/visual-aids/developers/guides/ios_sdk/Product Page Preview.png" />
