...
**Note**: `GenuinSDK.shared.willHandleDeepLink(url: dlURL)` function will check whether `GenuinSDK` will handle the given notification or not. You can use it according to your notification redirection flow.
