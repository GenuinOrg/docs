...
GenuinSDK.shared.ssoLogin(ssoToken: "example@gmail.com", params: ["name" :"John Doe", "nickname" : "john"]
...
1. **mobile** - This is an option string parameter. Pass this parameter for `signup/login`.
2. **email** - This is an optional string parameter. Pass this parameter for `signup/login`.
3. **nickname** - This is an optional string parameter. If nickname is available in genuin ecosystem it will be used, else genuin will generate of its own.
4. profile_image: This is an optional string parameter. Pass the `profile_image` parameter if you want to show the profile image in the SDK. (edited) 
...
1. **email** - This is an optional string parameter. Pass this parameter in the function if you want to pass it as a token. 
2. **nickname** - This is an optional string parameter. if nickname is available in genuin ecosystem it will be used, else genuin will generate of its own.
3. **profile_image** - currently not implemented from backend
4. **mobile** - This is an option string parameter. Pass this parameter for signup/login. This will be first priority instead of email.
