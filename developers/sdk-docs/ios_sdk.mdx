...
target 'YourProject' do
  ...
  pod "GenuinSDK", :git => "https://bitbucket.org/genuindev/genuin_sdk_ios.git", :tag => "1.1.16"
...
## Handle AutoLogin Explicitly in SDK

To Auto Login in the SDK, You need to call below method, whenever user is log in to your application. 

<Note> **Note**: You don't need to call the below method if you have implemented the Embed With AutoLogin already. </Note>
