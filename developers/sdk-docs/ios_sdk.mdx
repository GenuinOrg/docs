...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        configuration.setCustomLoader("YOUR_LOADER", bundle: Bundle(for: TabBarController.self))
...
To present brand's feed from your UIViewController by click on UIButton:
...
class ViewController: UIViewController {
    ...
    @IBAction func openFeed() {
        let configuration = GenuinConfiguration.shared
        configuration.showNavigationBar = true
        configuration.setCustomLoader("YOUR_LOADER", bundle: Bundle(for: ViewController.self))
        GenuinSDK.shared.initialize(apiKey: "YOUR_API_KEY", configuration: configuration)
