...
target 'YourProject' do
  ...
  pod "GenuinSDK", :git => "https://bitbucket.org/genuindev/genuin_sdk_ios.git", :tag => "1.0.14"
...
`interactionDeepLink` - It is an optional string parameter. By passing the deeplink in this parameter user will get interactive deeplink feed and from that user will be redirected to specific deeplink by any of the interaction in the feed. 
