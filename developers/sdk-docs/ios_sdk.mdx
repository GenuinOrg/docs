...
GenuinSDK.shared.initializeEmbed(embedId: "EMBED_ID", uniqueId: "YOUR_UNIQUE_ID", containerView: YOUR_VIEW, viewConroller: YOUR_VIEW_CONTROLLER, ssoToken: "johndoe@gmail.com", params: ["name" :"John Doe", "nickname" : "john", "mobile" :"919797979797"], contextualParams: ["page_context": "vfgdgrtg", "geo": { "lat": 24.2324, "long": 235.34 }], embedConfiguration: embedConfiguration)
