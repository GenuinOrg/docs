...
target 'YourProject' do
  ...
  pod "GenuinSDK", :git => "https://bitbucket.org/genuindev/genuin_sdk_ios.git", :tag => "1.1.17"
...
genuinCarouselConfiguration.aspectRatio = .ratio1x1
...
``` 
interTileSpacing: Double = 8.0
carouselInset: UIEdgeInsets = UIEdgeInsets(top: 8.0, left: 16.0, bottom: 0.0, right: 16.0)
scrollDirection: CarouselScrollDirection = .horizontal
aspectRatio: CarouselTileAspectRatio = .ratio9x16
tileCornerRadius: Double = 8.0
```
