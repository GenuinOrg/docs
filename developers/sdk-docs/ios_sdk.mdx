...
**Note**: Our SDK is well optimized for iOS version 15.0 and above, but if you are using iOS version 13 or 14 then put the below condition while importing the GenuinSDK
