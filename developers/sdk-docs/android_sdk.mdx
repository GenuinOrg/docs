...
implementation("org.bitbucket.genuindev:genuin_android_sdk:1.1.16@aar"){
        isTransitive=true
    }
```
...
<Note> 1. Complete the Advertising ID declaration in Play Console: 
...
Answer the questions on the form honestly. If your app uses Advertising ID, you'll need to select "YES.".

2. Submit your declaration:
- After answering the questions, submit your declaration. </Note>
