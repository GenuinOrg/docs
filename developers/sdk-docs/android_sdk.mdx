...
implementation("org.bitbucket.genuindev:genuin_android_sdk:1.1.1.1@aar"){
        isTransitive=true
    }
```
...
**Note**: For using this parameter, you must have [white labelled your domain](https://resources.begenuin.com/retail-media/build/how_to_white-label_your_community) first and also integrated the Handling deep link part in your main app in which you want to redirect this video to.
...
**Note**: Need to call this function everytime your app receives any deeplink. This method will handle deeplink if its our deeplink otherwise it will ignore that.
