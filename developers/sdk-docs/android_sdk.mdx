...
```kotlin Kotlin-settings.gradle.kts 
implementation("org.bitbucket.genuindev:genuin_android_sdk:1.0.7@aar{
  isTransitive=true
}
```
...
class YourApplication : Application() {
  override fun onCreate() {
    GenuinSDK.initSDK(this@MainActivity, "d9efe6b856b7a4c6a78f7e59f4953225e245796e583345fe")
  }
}
```
</CodeGroup>
