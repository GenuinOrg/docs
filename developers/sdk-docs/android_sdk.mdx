...
<Note> **Note**: Currently minimum SDK version of our SDK is 24 but if you want to use our SDK in version below 24, use the below code snippet in the App level manifest file. 
</Note>
