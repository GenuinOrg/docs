...
implementation("org.bitbucket.genuindev:genuin_android_sdk:1.1.15.1@aar"){
        isTransitive=true
    }
```
...
class YourApplication : Application() {
  override fun onCreate() {
    GenuinSDK.initSDK(this, "YOUR_API_KEY") // For Production Environment
    GenuinSDK.initSDK(this, "YOUR_API_KEY", genuinEnv = GenuinEnv.QA) // Add this line if you want to test in QA Environment
  }
}
...
class YourActivity : AppCompatActivity() {
  override fun onCreate(savedInstanceState: Bundle?) {
        ...
        GenuinSDK.initSDK(application, "YOUR_API_KEY") // For Production Environment
        GenuinSDK.initSDK(this, "YOUR_API_KEY", genuinEnv = GenuinEnv.QA) // Add this line if you want to test in QA Environment
    }
}
