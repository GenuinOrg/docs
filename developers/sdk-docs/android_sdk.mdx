...
**Note**: Make sure you have followed the [First 3 installation](https://resources.begenuin.com/developers/sdk-docs/android_sdk#installation) steps in order to implement the Carousel Embed
