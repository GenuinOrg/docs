...
**UniqueId** = This is optional parameters. This uniqueId is used when we need to display same embed in multiple screen. We need to provide distinct uniqueId for the same embedId in multiple/same screen.
...
carouselEmbedView.apply {
            setEmbedParams(
               embedId = "66f29f7dcffef5a29ad0acd6", 
