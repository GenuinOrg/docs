...
| -------- | ------------------- | -------- | 
| Core  | Includes the core functionality of the Genuin Ecosystem: Embeds and User authentication. | com.begenuin:core:2.1.0.3 |
| UI  | Additional UI flows like comments, search, deep-links, notifications, group/community detail etc. | com.begenuin:ui:2.1.0.3 |
| Camera  | Camera flows for video content creation. | com.begenuin:camera:2.1.0.3 |
| AI  | Additional flows for AI assisted community/group creation. | com.begenuin:ai:2.1.0.3 |
...
val genuinVersion = "2.1.0.3"
implementation("com.begenuin:core:$genuinVersion")
```

```kotlin Groovy-build.gradle
def genuinVersion = "2.1.0.3"
implementation "com.begenuin:core:$genuinVersion"
```
</CodeGroup>
...
Note: All modules must use a consistent version format — 2.1.0.3.
