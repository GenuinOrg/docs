...
configuration.environment = .qa
configuration.setCustomLoader("loader", bundle: .main)
...
GenuinSDK.shared.initialize(apiKey: AppConstants.API_KEY, configuration: configuration) 
