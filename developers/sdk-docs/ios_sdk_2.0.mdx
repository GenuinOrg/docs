...
| -------- | ------------------- | -------- | 
| Core  | Includes the core functionality of the Genuin Ecosystem: Embeds and User authentication. | pod "GenuinCore", :git => "https://bitbucket.org/genuindev/genuin_sdk_ios.git", :tag => 2.x.x |
| UI  | Additional UI flows like comments, search, deep-links, notifications, group/community detail etc. | pod "GenuinUI", :git => "https://bitbucket.org/genuindev/genuin_sdk_ios.git", :tag => 2.x.x |
| Camera  | Camera flows for video content creation. | pod "GenuinCamera", :git => "https://bitbucket.org/genuindev/genuin_sdk_ios.git", :tag => 2.x.x |
| AI  | Additional flows for AI assisted community/group creation. | pod "GenuinAI", :git => "https://bitbucket.org/genuindev/genuin_sdk_ios.git", :tag => 2.x.x |
...
When prompted, enter the Genuin SDK repository URL:
...
```
```Swith With customization and SSO
import SwiftUI
import UIKit
import GenuinCore
