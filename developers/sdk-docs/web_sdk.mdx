...
<CodeGroup>
  <CodeBlock title="Embed With Multi Embeds" language="html">
```html
...
<CodeGroup>
  <CodeBlock title="Embed with Multiple Embeds" language="html">
```html
...
```
  ...
  <CodeBlock title="Embed with Single Embeds" language="html">
```html
...
<CodeGroup>
  <CodeBlock title="Brand Community Embed" language="html">
```html
<div
  id="gen-sdk"
  style="max-width: 1080px; height: 720px; display: flex;">
