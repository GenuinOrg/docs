...
You can use the video parameter during SDK initialization—alongside other parameters—to directly open a specific video page instead of loading the default feed. This is especially useful for deep linking, opening videos from external sources, or triggering playback from custom buttons or landing pages.
