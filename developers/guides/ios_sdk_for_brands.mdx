...
After entering the details, you'll need to [record a post](https://resources.begenuin.com/developers/guides/ios_sdk_for_brands#record-your-first-video-for-loop) for the Loop to complete the creation process.
