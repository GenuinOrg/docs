---
title: "iOS App for Creators"
---

## Introduction to Genuin

Welcome to <Tooltip tip="This is a tooltip!"> Genuin! </Tooltip> <a href="https://google.com" target="_blank">Learn More</a> We help you easily build and manage communities, organize video content, and create custom avatars. It simplifies your tasks so you can focus on creating and engaging. Let’s get started!
...
<img height="200" src="/visual-aids/developers/guides/Help and support.png" />
...
<img height="200" src="/visual-aids/developers/guides/Profile Update.png" />
...
6. Decide who can create Groups: All Members or Moderators.
...
<img height="200" src="/visual-aids/developers/guides/Auto create community.png" />
...
7. Decide who can create Groups: All Members or Moderators.
8. Add Members to the Community.
9. For auto-generating some details, click “[Auto Create](https://resources.begenuin.com/developers/guides/ios_app_for_community_builders#auto-create-community).”

<img height="200" src="/visual-aids/developers/guides/Create Community.png" />
...
7. Decide who can post in the group: All Community Members or Members Only.
8. The Group name and description will be automatically generated. You can update these details by tapping “Retry With Prompt” and entering a new prompt.
9. After entering the details, you'll need to [record a post](https://resources.begenuin.com/developers/guides/ios_app_for_community_builders#manually-create-video) for the Group to complete the creation process.

<img height="200" src="/visual-aids/developers/guides/Auto create loop.png" />
...
5. Decide who can post in the group: All Community Members or Group Members Only.
6. Add Members.
7. After entering the details, you'll need to [record a post](https://resources.begenuin.com/developers/guides/ios_app_for_community_builders#manually-create-video) for the Group to complete the creation process.

<img height="200" src="/visual-aids/developers/guides/Manually create loop.png" />

## Record Your First Video for Group

After generating the Group details, it's time to create your first post.
...
<img height="200" src="/visual-aids/developers/guides/Manually create video for Loop.png" />
...
<img height="200" src="/visual-aids/developers/guides/Auto create loop video for Loop.png" />
...
6. Once editing is complete, tap "Next" to [post the video](https://resources.begenuin.com/developers/guides/ios_app_for_community_builders#record-your-first-video-for-loop).

<img height="200" src="/visual-aids/developers/guides/Auto create loop video for Loop-1.png" />
