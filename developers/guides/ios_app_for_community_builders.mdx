Certainly! Here is the content formatted in MDX:
...
To get started with Genuin, simply download the app from your device’s app store. Once installed, open the app and follow the instructions to sign up or log in.
...
This MDX format organizes the content with clear headings and steps for each section, making it easy to follow for users.
