...
9. After entering the details, you'll need to [record a post](https://resources.begenuin.com/developers/guides/ios_app_for_community_builders#manually-create-video) for the Loop to complete the creation process.
...
6. Add Collaborators.
7. After entering the details, you'll need to [record a post](https://resources.begenuin.com/developers/guides/ios_app_for_community_builders#manually-create-video) for the Loop to complete the creation process.
