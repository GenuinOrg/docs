      ...
      <Accordion title="2025"> {/* Year Accordion */}
        <AccordionGroup>
          ...
          <Accordion title="Februrary">
            ...
            **V 1.1.10.2**  
            - Updated authentication flow with refined [SSO parameters](https://resources.begenuin.com/developers/sdk-docs/android_sdk#handle-sso-login-explicitly-in-sdk)
