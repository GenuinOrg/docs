...
| Subscriber
(notified)
 | A subscriber is the loop level entity who chooses to follow specific topics they're interested in. | Subscribers can interact and stay up to date with the loop they have subscribed to, request to be the collaborator and also view & interact with the public content of the community. |